...
def home(request):
    ...
    return render(request, 'temp/home/home.html', {"allabout": allabout, "allSkills":allSkills, "allService": allService, "allTesti":allTesti, 'allFilter':allFilter, 'allImg':allImg, "allContact":allContact})